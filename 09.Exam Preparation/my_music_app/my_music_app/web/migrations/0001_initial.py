        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.CharField(
                    choices=[('POP', 'Pop Music'), ('JAZZ', 'Jazz Music'), ('RNB', 'R&B Music'), ('ROCK', 'Rock Music'),
                             ('COUNTRY', 'Country Music'), ('DANCE', 'Dance Music'), ('HIP_HOP', 'Hip Hop Music'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=15, validators=[django.core.validators.MinLengthValidator(2),
                                                                         my_music_app.web.validators.validate_only_alphanumeric])),
